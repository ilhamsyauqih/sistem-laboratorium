    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {modalOpen && ReactDOM.createPortal(
                ...
                >
                    <div className="w-full max-w-lg max-h-[85vh] bg-white rounded-2xl flex flex-col shadow-2xl animate-in zoom-in-95 duration-300 overflow-hidden">
                        {/* Header - Fixed */}
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0 overflow-hidden">
                            ...
                            {/* Footer - Fixed */}
                            <div className="shrink-0 flex justify-end gap-3 p-6 bg-slate-50/50 border-t border-slate-100 rounded-b-2xl">
                                <Button type="button" variant="ghost" onClick={() => setModalOpen(false)} className="hover:bg-slate-200 transition-colors">Batal</Button>
                                <Button type="submit" disabled={uploading} className={cn("min-w-[120px] transition-all", editId ? "bg-blue-600 hover:bg-blue-700" : "bg-primary-600 hover:bg-primary-700")}>
